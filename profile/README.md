...
GNN, PGExplainer 기반 위험도 예측, Neo4j 기반 지식그래프 분석, LangChain 기반 자연어 해석을 통해 지갑주소의 위험 점수와 근거를 사용자에게 제공합니다.

BlockList는 거래소·핀테크·PG사가 사용하는 B2B 온체인 AML 서비스이지만, 그 목적은 일반 사용자의 금융 안전을 지키는 것에 있습니다.
...
기업 서비스 내부에 자연스럽게 스며들어 사용자 경험을 방해하지 않으면서도, 뒤에서 조용히 일상 속 디지털 금융을 더 안전하게 만들어주는 안전장치가 되는 것이 BlockList의 핵심 목표입니다.
